...
Read this file first. Then load only the files relevant to your task — do not load all files by default.

| File | Read when you need |
|---|---|
| `company.md` | Legal entity, offices, co-founders, certifications, infrastructure, customer scale |
